...
<!-- jmmj13-001-site1.smarterasp.net/lectores/ayudamantener.html -->
  ...
  <body>
        ...
        <div id="login"></div>
        <div id="modall"></div>
        <div id="registroperfil margenArribaAbajo" class="container">
            <div class="row">
                <div class="col-xs-12 toppad" >
                    <div id="cambiarPassBord" class="panel panel-info">
                        <div class="col-xs-12">
                            ...
                            <div class="panel-body">
                                <div class="row">
                                    <div class=" col-md-12 col-lg-12 ">                               
                                        ...
                                        <a href="#" id="btnCambiarPass" class="btn btn-primary">Cambiar Contraseña</a>
                                    </div>
                                </div>
                            </div> 
                        </div>  
